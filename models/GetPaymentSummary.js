function ExecuteQuery(PaymentID, con, callback) {
  ...
  var sql = "SELECT pay.PaymentID, payid.PaymentHashCode, pay.TotalAmount, pay.AmountPaid, pay.Date from patientpaymentrecord pay left join patientpaymentsidentifiers payid on pay.PaymentID = payid.PaymentID where pay.PaymentID = " + PaymentID + ";";
  console.log(sql);
